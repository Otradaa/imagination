...
namespace GatewayService.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        private readonly IGatewayService _gate;

        public RegisterModel(
            UserManager<Data.Account> userManager,
            SignInManager<Data.Account> signInManager,
            ILogger<RegisterModel> logger, IGatewayService gate,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var profile = new User() { Email = Input.Email, FirstName = Input.FirstName,
                    LastName = Input.LastName, ShortName = Input.ShortName };
                int profileId = await _gate.AddUser(profile);
                if (profileId != 0)
                {
                    var user = new Data.Account { UserName = Input.Email, Email = Input.Email, ProfileId = profileId };
